...
//			pstmt = conn.prepareStatement(sql);
	...
	public void insertBoard(BoardDTO board)  {
		...
		try {
			...
			String sql = "insert into board values(num_seq.nextval, ?, ?, ?, ?, ?, ?, ?, 'admin')";
	...
	public BoardDTO getBoardByNum(int num, int page) {
		...
		try {
			...
			if (rs.next()) {
				...
				board.setHit(rs.getInt("hit"));
				board.setIp(rs.getString("ip"));
				board.setAdmin(rs.getString("a_id"));
			}
	...
	public void deleteBoard(int num) {
		...
		String sql2 = "update board set num=num-1 where num > ?";
		String sql3 = "alter sequence num_seq increment by -1";
		String sql4 = "select num_seq.nextval from dual";
		String sql5 = "alter sequence num_seq increment by 1";
